...
void MAIN_body__(MAIN *data__) {
  ...
  __SET_VAR(data__->,STOP,,(__GET_VAR(data__->COUNTERDN,) || __GET_LOCATED(data__->STOPBUT,)));
  __SET_EXTERNAL(data__->,ST1,,((!(__GET_VAR(data__->STOP,)) && !(__GET_EXTERNAL(data__->ST2,))) && ((__GET_EXTERNAL(data__->ST1,) || (__GET_LOCATED(data__->STARTBUT,) && __GET_EXTERNAL(data__->ST0,))) || (__GET_VAR(data__->TIME2DN,) && __GET_EXTERNAL(data__->ST5,)))));
  __SET_EXTERNAL(data__->,ST2,,((!(__GET_VAR(data__->STOP,)) && !(__GET_EXTERNAL(data__->ST3,))) && (__GET_EXTERNAL(data__->ST2,) || (__GET_LOCATED(data__->BOXBUT,) && __GET_EXTERNAL(data__->ST1,)))));
  __SET_EXTERNAL(data__->,ST3,,((!(__GET_VAR(data__->STOP,)) && !(__GET_EXTERNAL(data__->ST4,))) && (__GET_EXTERNAL(data__->ST3,) || (__GET_LOCATED(data__->BREAKBEAM,) && __GET_EXTERNAL(data__->ST2,)))));
  ...
  __SET_EXTERNAL(data__->,ST5,,((!(__GET_VAR(data__->STOP,)) && !(__GET_EXTERNAL(data__->ST1,))) && (__GET_EXTERNAL(data__->ST5,) || (__GET_LOCATED(data__->BREAKBEAM2,) && __GET_EXTERNAL(data__->ST4,)))));
