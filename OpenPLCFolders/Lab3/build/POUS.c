...
void MAIN_init__(MAIN *data__, BOOL retain) {
  ...
  __INIT_VAR(data__->COUNT_VALUE,0,retain)
...
void MAIN_body__(MAIN *data__) {
  ...
  __SET_EXTERNAL(data__->,ST0,,(__GET_VAR(data__->STOPBUT,) || ((((!(__GET_EXTERNAL(data__->ST5,)) && !(__GET_EXTERNAL(data__->ST4,))) && !(__GET_EXTERNAL(data__->ST3,))) && !(__GET_EXTERNAL(data__->ST2,))) && !(__GET_EXTERNAL(data__->ST1,)))));
  ...
  __SET_EXTERNAL(data__->,ST1,,(!(__GET_EXTERNAL(data__->ST2,)) && ((__GET_EXTERNAL(data__->ST1,) || (__GET_VAR(data__->STARTBUT,) && __GET_EXTERNAL(data__->ST0,))) || (__GET_VAR(data__->TIME2DN,) && __GET_EXTERNAL(data__->ST5,)))));
  ...
  __SET_VAR(data__->,COUNT_VALUE,,__GET_VAR(data__->CTU0.CV,));
  ...
  __SET_EXTERNAL(data__->,ST5,,(!(__GET_EXTERNAL(data__->ST1,)) && (__GET_EXTERNAL(data__->ST5,) || (__GET_VAR(data__->BREAKBEAM2,) && __GET_EXTERNAL(data__->ST4,)))));
