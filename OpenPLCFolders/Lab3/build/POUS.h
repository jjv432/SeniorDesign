...
typedef struct {
  ...
  __DECLARE_LOCATED(BOOL,BOXBUT)
  __DECLARE_LOCATED(BOOL,STARTBUT)
  __DECLARE_VAR(BOOL,TIMEDN)
  __DECLARE_LOCATED(BOOL,BREAKBEAM)
  __DECLARE_LOCATED(BOOL,BREAKBEAM2)
  __DECLARE_LOCATED(BOOL,STOPBUT)
  __DECLARE_LOCATED(BOOL,MOTOR)
  TON TON0;
  __DECLARE_LOCATED(BOOL,LINEARACT)
